...
\begin{itemize}
    ...
    \begin{figure}[h!]
        \centering
        \setchemfig{arrow style={blx,semithick}}
        \begin{subfigure}[b]{0.45\linewidth}
            ...
            \schemestart
                ...
                \arrow[-90]
                \chemfig{M(-[7]H)(-[:30]-[:-30])}
                \arrow{-U>[][*{0.90}\footnotesize\hbox{\chemfig[atom sep=1.4em]{-[1]}}][][][90]}[180]
        ...
        \begin{subfigure}[b]{0.45\linewidth}
            ...
            \schemestart
                ...
                \arrow{-U>[][*{0}\footnotesize\hbox{\chemfig[atom sep=1.4em]{-[1]}}][][][120]}[90]
            \schemestop
    ...
    \begin{figure}[H]
        ...
        \schemestart
            ...
            \chemright{]^\ddagger}
            \arrow{-U>[][*{0.20}\footnotesize\hbox{\chemfig[atom sep=1.4em]{R-[:30]-[:-30]}}][][][135]}[90,1.3]
        \schemestop
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{0.9\linewidth}
            ...
            \schemestart
                ...
                \chemfig{-[:30](-[2]OH)-[:-30]}
            \schemestop\\[1em]
            \chemmove{\draw ([yshift=-4mm]c4.south) -- (c4.south |- 0,0) -- node[above]{\small\ce{H2}} (c1.south |- 0,0) -- ([yshift=-4mm]c1.south);}
            \begin{tikzpicture}
                \path (0,0) -- (0,-1);
            \end{tikzpicture}
            \caption{Ionic.}
...
\begin{itemize}
    ...
    \begin{figure}[h!]
        ...
        \schemestart
            ...
            \arrow{-U>[][*{0}\footnotesize\hbox{\chemfig[atom sep=1.4em]{-[:30]-[:-30]-[:30](=[2]O)-[:-30]H}}][][][120]}[90]
