...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item They made compounds such as \ce{W(CH3)6}, \ce{M-CH2-Ph}, \ce{M-CH2-{$t$-}Bu}, and \ce{M-CH2-TMS}\footnote{TMS is \underline{t}ri\underline{m}ethyl\underline{s}ilyl, a ligand of the structure \ce{SiMe3}.}.
    ...
    \begin{figure}[h!]
        ...
        \schemestart
            ...
            \arrow{->[\small 6 ClMgNp]}[,1.5]
            \chemfig{W(-[2]Np)(~[:-30]-[::0]{\emph{t}-}Bu)(<[:-110]Np)(>:[:-150]Np)}
            \arrow{->[\small 3 HCl][\footnotesize\chemfig{MeO-[1]--[7]OMe}]}[,2]
            \chemfig{W?(~-{\emph{t}-}Bu)(-[1]Cl)(-[2]Cl)(-[4]O(-[:120])-[:-150,0.6]-[:-60,0.5]-[:-20,0.7]O?(-[:-60]))(-[6]Cl)}
            \arrow{->[][*{0}\footnotesize\chemfig{**6(---(-(-[2])(-[:-30]))-(-[,,,2]HNTMS)-(-(-[2])(-[:-150]))-)}]}[-90,2]
            \chemfig{W?(~-{\emph{t}-}Bu)(-[1]Cl)(-[2,,,2]HNAr)(-[4]O(-[:120])-[:-150,0.6]-[:-60,0.5]-[:-20,0.7]O?(-[:-60]))(-[6]Cl)}
            \arrow{->[\small\ce{NEt3}]}[180]
            \chemfig{W?(=[:30]-[:-30]{\emph{t}-}Bu)(=[2]\chemabove{N}{Ar})(-[4]O(-[:120])-[:-150,0.6]-[:-60,0.5]-[:-20,0.7]O?(-[:-60]))(-[6]Cl)}
            \arrow{->[\small MOR]}[180]
...
\begin{itemize}
    ...
    \begin{figure}[h!]
        \centering
        \chemfig{M-[2]-[:-157,0.85,,,white]=[1]-=[5]}
        \caption{Butadiene.}
        \label{fig:butadiene}
    \end{figure}
    \begin{itemize}
...
\begin{tchart}{1.4}{Linear}{Bent}
    \chemfig[atom sep=1.2em]{M-\charge{90[yshift=1mm]=$\oplus$}{N}~\charge{90[yshift=1mm]=$\oplus$,0=\:}{O}} & \chemfig[atom sep=1.2em]{M-[:30]\charge{90=\:}{N}=[:-30]\charge{0=\:,-90=\:}{O}}\rule{0pt}{0.9cm}\\
    LX-type. & X-type.\\
    $3\,\e[-]$ donor. & $1\,\e[-]$ donor.\\
...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.3\linewidth}
            \centering
            \chemfig{=[:30]-[:-30]\charge{-90[yshift=-1.5mm]=$\ominus$}{}}
            \vspace{1em}
            \caption{The ligand.}
    ...
    \begin{figure}[h!]
            ...
            \begin{tikzpicture}
                \node{
                    \schemestart
                        ...
                        \arrow{->[$\ce{Nu}^-$]}
                        \chemleft{[}
                            \chemfig{M-\phantom{i}-[2,0.35,,,white]=[6]-[:-60]-[6]Nu}
                        \chemright{]^-}
                    \schemestop
                };
            ...
            \begin{tikzpicture}
                \node{
                    \schemestart
                        ...
                        \arrow{->[$\ce{E}^+$]}
                        \chemleft{[}
                            \chemfig{M-\phantom{i}-[2,0.35,,,white]=[6]-[:-60]-[6]E}
                        \chemright{]^+}
                    \schemestop
                };
        ...
        \begin{subfigure}[b]{0.9\linewidth}
            ...
            \begin{tikzpicture}
                \node{
                    \schemestart
                        \chemfig{M(-[1]\phantom{i}-[::-100,0.7,,,white]-[::160]-[::60]-[::-60]R)(-[7]\phantom{i}-[::-100,0.7,,,white](-[::40]R)-[::160]-[::60])}
                        \arrow{->}
                        \chemfig{M^0}
                        \arrow{0}[,0]\+{,,1.6cm}
                        \chemfig{R-[2]=[:150]-[2]=[:30]-[2]R}
                    \schemestop
                };
                \draw [dashed,xshift=9.3mm,rotate=45] (-1.5,1.71) arc (-35:35:1);
                \draw [dashed,xshift=9.3mm,rotate=-45] (-1.47,-2.78) arc (-35:35:1);
            \end{tikzpicture}
...
\begin{itemize}
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{0.3\linewidth}
            \centering
            \chemfig{L_{\emph{n}}M(-[1]H)(-[7]H)}
            \caption{General dihydride.}
            \label{fig:nonclassicalHydridea}
        \end{subfigure}
        \begin{subfigure}[b]{0.3\linewidth}
            \centering
            \chemfig{L_{\emph{n}}M-[,,,,{stealth-}]\phantom{i}-[2,0.33,,,white]H-[6]H}
