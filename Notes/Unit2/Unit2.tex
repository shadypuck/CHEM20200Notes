...
\begin{itemize}
    ...
    \item Three typse of compounds: Carbenes/alkylidenes (\ce{M=CR2}), carbynes/alkylidynes, and carbides.
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item We predict stoichiometry (i.e., constitutinal isomerism) with the $18\,\e[-]$ rule (except for square planar).
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \ce{Mo(CO)6 ->[$\Delta$ TMEDA] (CO)4Mo(EPA) ->[4NaNH3] Na4Mo(CO)4^4-}.
        \begin{itemize}
            \item This is $d^0$ and thus $\nu_{\ce{CO}}<<<\SI{2000}{\per\centi\meter}$.
    ...
    \begin{itemize}
        ...
        \item \ce{C-O} $\text{BDE}=\SI[per-mode=symbol]{1075}{\kilo\joule\per\mole}$\footnote{Note that BDE is short for boond dissociation energy.}.
        \begin{itemize}
