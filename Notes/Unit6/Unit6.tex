...
\begin{itemize}
    ...
    \begin{figure}[h!]
        ...
        \begin{tikzpicture}[overlay]
            \draw [-stealth] (-7,-5.5) arc(-170:-10:1.16cm) node[below,pos=0.5]{\small base} ;
    ...
    \end{equation*}
    \footnotetext{All is an allyl group. DEM is diethyl malonate (see the second reactant in Figure \ref{fig:allylicSubstitution-epoxidea}).}
    \begin{itemize}
