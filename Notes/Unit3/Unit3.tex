            ...
            \begin{tikzpicture}[
                ...
                \draw [blx,thick] (0,0)
                    ...
                    to[out=0,in=180] (3,-0.2) node[below]{
                        \chemfig{R-[:30]@{C1}-[:-30]@{C2}-[:150,0.4,,,white]\phantom{i}-[:60,,,,dashed]B{(}OR{)_2}-[:160,,1,,dashed]H}
                        \chemmove{\draw [dashed,-] ([xshift=1pt,yshift=2pt]C1.center) -- ([xshift=1pt,yshift=2pt]C2.center);}
                    }
            ...
            \begin{tikzpicture}[
                ...
                \draw [rex,thick] (0,0)
                    ...
                    to[out=0,in=180] (5,-0.7) node[below]{
                        \chemfig{M(-[1]B{(}OR{)_2})(-[7]H)(-[6]\phantom{i}-[,0.4,,,white]=_[4]-[:-120]R)}
                    }
        ...
        \begin{subfigure}[b]{0.35\linewidth}
            ...
            \begin{tikzpicture}[
                ...
                \node (2) at (0:2.2) {\ce{L_nM*S}}
                    edge [stealth-,out=90,in=0] node[above right]{\ce{S}} (1)
                ;
...
\begin{itemize}
    ...
    \end{itemize}
    \item Heteroarene coupling partners\footnote{Note that \ce{TfO} is triflate, an abbreviation of trifluoromethanesulfonate, which is an excellent leaving group.}:
    \begin{figure}[h!]
        \centering
        \schemestart
            \chemfig{[:-18]*5(-X-=--)}
        ...
        \begin{subfigure}[b]{0.8\linewidth}
            ...
            \begin{tikzpicture}
                ...
                \node (3) at (-54:3) {\chemfig{{\ce{L_{n-2}}Pd(-[:30]Ar)(-[6,,2]\phantom{i}-[4,0.4,,,white]=^-[:-60]R)(-[:-30]X)}}}
                    edge [blx,semithick,stealth-,bend right=15] node[black,left]{\ce{-L}} node[black,thin,-,right]{\chemfig{[:-30]=_[:30]-R}} (2)
                ;
    ...
    \begin{itemize}
        ...
        \item On the subject of boronic acids, Negishi proposes the following: \ce{L2PdPhBr ->[KOH] [LPhPd($\mu${-}OH)]2 ->[Ar(BOH)2] Ar-Ph}, $70\%$.
        \begin{itemize}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{figure}[H]
            ...
            \schemestart
                ...
                \arrow{->}
                \chemleft{(}
                    \chemfig{@{C1}-[,0.5]@{C2}-[:120]-[:60]--[:-60]-[:-120]@{C3}-[,0.5]@{C4}}
                \chemright{)_n}
            \schemestop
            \chemmove{
                \draw [-] ([yshift=2pt]C1.center) -- ([xshift=-3.5pt,yshift=2pt]C2.center);
                \draw [-] ([xshift=3.5pt,yshift=2pt]C3.center) -- ([yshift=2pt]C4.center);
            }
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{0.2\linewidth}
            \centering
            \chemfig{Ru(=_-[:-60]Ph)(>:[1]Cl)(-[2]PR_3)(<[5]Cl)(-[6]PR_3)}
            \caption{Grubbs I.}
            \label{fig:olefinMetathesisCatalystsb}
        \end{subfigure}
        \begin{subfigure}[b]{0.26\linewidth}
            \centering
            \chemfig{Ru(=_-[:-60])(>:[1]Cl)(-[2]*5(-N(-Ar)---N(-Ar)-))(<[5]Cl)(-[6]PR_3)}
        ...
        \begin{subfigure}[b]{0.27\linewidth}
            \centering
            \chemfig{Ru?(=_-[:-60]**6(-(-[,1.13]O?-[:-120]R)--(-R)---))(>:[1]Cl)(-[2]L)(<[5]Cl)}
    ...
    \begin{figure}[h!]
        \centering
        \schemestart
            \chemfig{\ce{L_n}M=^-[:60]R}
            \arrow{->[\footnotesize\chemfig[atom sep=1.4em]{R'-[:30]=_[:-30]}]}[,1.5]
            \chemleft{[}
                \chemfig{\ce{L_n}@{M}M?-@{C1}(<[:-30,0.8]R)-[6,1.2,,,dashed]@{C2}(>:[:-20,0.7]R')-[4,1.23]?[,,dashed]@{C3}}
            \chemright{]^\ddagger}
            \arrow
            \chemfig{[7]\ce{L_n}M*4(--(>:R')-(<[2]R)-)}
            \arrow{-U>[][*{0.-160}\footnotesize\subscheme{
                \chemfig[atom sep=1.4em]{R-[:-60]=^-[:60]R'}
                \arrow{0[*{0.135}or]}[-90,0.4]
                \chemfig[atom sep=1.4em]{R-[:30]=^[:-30]-[:30]R'}
            }][][][135]}[-90,2]
            \chemfig{\ce{L_n}M=CH_2}
            \arrow{->[\footnotesize\chemfig[atom sep=1.4em]{R-[:30]=_[:-30]}]}[180,4.5]
            \chemfig{[7]\ce{L_n}M*4(-(-R)---)}
            \arrow{-U>[][*{0.-20}\footnotesize\hbox{\chemfig[atom sep=1.4em]{=[1]}}][][][110]}[90,1.8]
        \schemestop
        \chemmove{
            \draw [dashed,-] ([xshift=3pt,yshift=-2pt]M.east) -- ([xshift=-2pt,yshift=-2pt]C1.center);
            \draw [dashed,-] ([xshift=-2pt,yshift=2pt]C2.center) -- ([xshift=2pt,yshift=2pt]C3.center);
        }
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{0.9\linewidth}
            ...
            \schemestart
                ...
                \arrow{->[\footnotesize\chemfig[atom sep=1.4em]{R-~-R}]}[,1.6]
    ...
    \begin{figure}[h!]
        ...
        \schemestart
            ...
            \arrow{->[\footnotesize\chemfig[atom sep=1.4em]{~-R'}]}[,1.3]
            \chemfig{\ce{L_n}Ru(=^-[:60]R)-[6,,2]\phantom{i}-[,0.4,,,white]~[4]-[4]R'}
            \arrow
            ...
            \arrow{-U>[][*{0.40}\footnotesize\hbox{\chemfig[atom sep=1.4em]{R'-[:30](=[2])-[:-30]=^[:30]-[:-30]R}}][][][135]}[90,1.5]
        \schemestop
