...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \schemestart
            \chemfig{M-H}
            \arrow{->[\small\subscheme{2\arrow{0}[,0.1]\footnotesize\chemfig[atom sep=1.4em]{=[1]}}]}
            \chemfig{M(-[:30]-[:-30])(-[7]\phantom{i}-[1,0.4,,,white]=[5])}
            \arrow
            \chemfig{[:-30]M*6(------)}
            \arrow[,1.1]
            \chemfig{M?(-[2]\phantom{i}-[4,0.4,,,white]=-[::-30,1]-[::-50,0.9]-[::-70,0.8]?)(-[6]H)}
            \arrow{-U>[][*{0.-150}\footnotesize\hbox{\chemfig[atom sep=1.4em]{-[:30]-[:-30]=^[:30]}}][][][135]}[-90]
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \ce{Ni(P(o-Tol)3)4}\footnote{Note that \ce{o-Tol} is an ortho-tolyl group.}: Selects for the terminal product, especially with sterically encumbered (i.e., geminal) olefins.
...
\begin{itemize}
    ...
    \begin{figure}[h!]
        ...
        \schemestart
            ...
            \arrow{->[\small\subscheme{2\arrow{0}[,0.1]\footnotesize\chemfig[atom sep=1.4em]{R-[1]O-[7]H}\arrow(.east--.west){0}[90,0]\+{,,0.1em}\small\chemfig{B}}][\small\ce{-[HB]Cl}]}[,2.1]
            \chemfig{Pd(-[1]O(-R)(-[2]H))(-[3]Cl)(-[5]O(-[4]H)(-[6]R))(-[:-30]-[:30]-[:-30]O-[:30]R)}
            \arrow{-U>[][*{0.-100}\footnotesize\hbox{\chemfig[atom sep=1.4em]{R-[1]O-[7]H}}][][][150]}[-90]
            \chemfig{Pd(-[1]H)(-[3]Cl)(-[5]O(-[4]H)(-[6]R))(-[7]\phantom{i}-[::90,0.4,,,white]=_[::180]-[::60]O-[::90]R)}
            \arrow{-U>[\footnotesize\chemfig[atom sep=1.4em]{R-[1]O-[7]H}][\footnotesize\chemfig[atom sep=1.4em]{=_[:30]-[:-30]O-[:30]R}]}[180,2.2]
            \chemfig{Pd(-[1]H)(-[3]Cl)(-[5]O(-[4]H)(-[6]R))(-[7]O(-[6]H)(-R))}
            \arrow{-U>[][\small\ce{HCl}][][][90]}[180,1.4]
    ...
    \begin{figure}[H]
        ...
        \schemestart
            ...
            \arrow(@a--){-U>[\footnotesize\chemfig[atom sep=1.4em]{=[1]}][*{0.-45}\footnotesize\hbox{\chemfig[atom sep=1.4em]{=_[:30]-[:-30]R}}]}[,2]
